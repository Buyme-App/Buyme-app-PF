...
const clickHandler = (e)=> {
    ...
    return (
        <div className={styles.box}>
            <ul>
                <li ><button className={`${styles.btn} ${panelActive.home && styles.active}`}  type="submit" id="home" onClick={(e) => clickHandler(e.target.id)}><img className={styles.iconH} src={iconHome} alt="icon"/><span>Home</span> </button></li>

                <li  ><button className={`${styles.btn} ${panelActive.sales && styles.active}`} type="submit" id="sales" onClick={(e) => clickHandler(e.target.id)}><img className={styles.iconS} src={iconSale} alt="icon"/>Sales</button></li>

                <li  ><button className={`${styles.btn} ${panelActive.newProduct && styles.active}`} type="submit" id="newProduct" onClick={(e) => clickHandler(e.target.id)}><img className={styles.iconNP} src={iconNP} alt="icon"/>New Product</button></li>

                <li ><button className={`${styles.btn} ${panelActive.products && styles.active}`} type="submit" id="products"  onClick={(e) => clickHandler(e.target.id)}><img className={styles.iconP} src={iconProd} alt="icon"/>Products</button></li>
                ...
                <li  ><button className={`${styles.btn} ${panelActive.account && styles.active}`} type="submit" id="account" onClick={(e) => clickHandler(e.target.id)}>Account</button></li>
            </ul>
